...
These are things that basically every object supports. Implementations of these
methods are usually generated by functional classes rather than written by hand.
=cut
